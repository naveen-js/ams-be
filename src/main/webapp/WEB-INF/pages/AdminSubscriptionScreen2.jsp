...
<body class="overlay-scrollbar">
	...
	<div class="mainPage" id="main">
		...
		<form>
			...
			<select name="selectMilkType" id="selectMilkType">
								...
								<tr>
									...
									<c:choose>
										...
										<c:when test="${subscriptionMap['deliveryId'] == null}">
											<td><input type="input"
												name="deliveryId_${subscriptionMap['subscriptionId']}"
												value="0"></td>
										</c:when>
									...
									<td align="center"><select id="dropdown[]"
										name="delBoyName_${subscriptionMap['subscriptionId']}">
									...
									<td align="center"><select
										name="delStatus_${subscriptionMap['subscriptionId']}">
											<c:choose>
												<c:when test="${subscriptionMap['deliveryId'] != null}">
									...
									<td><select
										name="comment_${subscriptionMap['subscriptionId']}">
											<option value="Test">Test</option>
											<option value="Test">Test</option>
											<option value="Test">Test</option>
	...
	<script type="text/javascript">
		function doAjaxPost() {
			...
			$.ajax({
				type : "GET",
				url : "subView?milkType=Buffalo Milk",
				...
				.ready(
						function() {
							$("#selectMilkType")
									.change(
											function() {
												var selectMilkType = $(this)
														.val();
												alert(selectMilkType);
												$
														.ajax({
															type : 'GET',
															url : "${pageContext.request.contextPath}/subscription/getSortedList?milkType="
																	+ selectMilkType,
															success : function(
																	response) {
																alert(response);
